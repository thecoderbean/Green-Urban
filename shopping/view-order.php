		...
		<div class="content-blog content-account">
			...
			<div class="row">
				<div class="col-md-6">
					...
					<?php
						$csql = "SELECT u1.firstname, u1.lastname, u1.address, u1.city, u1.state, u1.country, u.email, u1.mobile, u1.zip FROM users u JOIN usersmeta u1 WHERE u.id=u1.uid AND u.id=$uid";
